...
export default function Home() {
  return (
    <>
      <div className="grid md:grid-cols-[4fr_2fr] md:mt-8 md:mb-20 items-stretch">
        <div className="grid grid-rows-[auto_auto]">
          <div className="bg-gray text-gray-100">
            <div className="grid md:grid-cols-[1fr_auto] gap-10 items-end">
              <div className="px-10 my-12 md:my-24">
                <div className="text-6xl font-bold dark:text-white mb-4">
                  Pablo Viojo
                </div>
                <div className="font-light text-xl block mb-8  ">
              ...
              <div className="pt-0 pr-0 hidden md:block">
                <Image
                  src="/images/im3.png"
                  alt=""
                  width="400"
        ...
        <div className="grid grid-rows-[auto_1fr]">
          <div className="bg-gray-3 text-gray-100 p-10">
          ...
          <div className="bg-gray text-gray-100 p-10">
