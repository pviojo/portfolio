...
export default function Home() {
  return (
    <>
      <div className="bg-marked dark:text-gray-100 text-gray-700  border-sep" >
        <div className="inner" >
          <div className="grid md:grid-cols-[1fr_400px] items-end h-[100dvh] md:h-auto">
      ...
      <div className="inner" >
        <div className="grid md:grid-cols-[1fr_400px] md:mt-8 md:mb-40 mb-20 items-stretch gap-10 text-gray-700 dark:text-gray-100">
